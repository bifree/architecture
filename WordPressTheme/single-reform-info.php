                ...
                <div class="custom-home-slider-area__bg">
                    ...
                    <ul id="slider" class="custom-home-slider-area__img-wrap">
                        <li class="custom-home-slider-area__img slider-01 horizontal-img">
													<img src="<?php the_field('thumbnail1'); ?>" alt="" class="examplephoto">
                        </li>
                        <li class="custom-home-slider-area__img slider-01 horizontal-img">
													<img src="<?php the_field('thumbnail2'); ?>" alt="" class="examplephoto">
                        </li>
                        <li class="custom-home-slider-area__img slider-01 horizontal-img">
													<img src="<?php the_field('thumbnail3'); ?>" alt="" class="examplephoto">
                        </li>
                        <li class="custom-home-slider-area__img slider-01 horizontal-img">
													<img src="<?php the_field('thumbnail4'); ?>" alt="" class="examplephoto">
                        </li>
                        <li class="custom-home-slider-area__img slider-01 horizontal-img">
													<img src="<?php the_field('thumbnail5'); ?>" alt="" class="examplephoto">
												</li>
                    </ul>
                </div>
